    ...
    return (
        <>
            <div className="fixed right-5 bottom-5 flex items-center justify-center">
                ...
                >
                    <PlusCircleIcon className='w-16 h-16 text-blue-600 rounded-full cursor-pointer duration-300 transition-all hover:scale-110 hover:text-blue-700 active:text-blue-800' />
                </button>
            </div>
